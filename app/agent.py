...
- MANDATORY PARTITION CHECKING & CLARIFICATION: All transaction ledgers are strictly partitioned by date. If the user asks for aggregate store revenue or sales across stores without specifying a date or timeframe, DO NOT run an unpartitioned scan. Clarify immediately:
